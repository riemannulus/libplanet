...
namespace Libplanet.State.Legacy
{
    ...
    /// <see cref="ILegacyStateDelta"/> instance with updated states.
    /// </remarks>
    public interface ILegacyStateDelta : ILegacyStateView
    {
        /// <summary>
        ...
        /// <returns>A new <see cref="ILegacyStateDelta"/> instance that
        ...
        /// but returns a new <see cref="ILegacyStateDelta"/> instance
        /// with updated states instead.
        /// </remarks>
        [Pure]
        ILegacyStateDelta SetState(Address address, IValue state);
        ...
        /// <returns>A new <see cref="ILegacyStateDelta"/> instance that the given <paramref
        ...
        [Pure]
        ILegacyStateDelta MintAsset(Address recipient, FungibleAssetValue value);
        ...
        [Pure]
        ILegacyStateDelta TransferAsset(
            Address sender,
            Address recipient,
        ...
        [Pure]
        ILegacyStateDelta BurnAsset(Address owner, FungibleAssetValue value);
    }
}
